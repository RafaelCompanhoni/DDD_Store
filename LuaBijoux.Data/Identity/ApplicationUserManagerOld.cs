...
namespace LuaBijoux.Data.Identity
{
    ...
    public class ApplicationUserManagerOld : IApplicationUserManager
    {
        private readonly UserManager<ApplicationIdentityUser, int> _userManager;
        private readonly IAuthenticationManager _authenticationManager;
        private bool _disposed;
        public ApplicationUserManagerOld(UserManager<ApplicationIdentityUser, int> userManager, IAuthenticationManager authenticationManager)
        {
